...
#define  TERMINAL_OS_CFG_TASK_PRIO                        8u
// 阈值,最小抢占值
#define  TERMINAL_OS_CFG_TASK_THRESHOLD_PRIO                    8u
...
#define  TERMINAL_CFG_MAX_CMD_LEN                        64u   /* Cfg max cmd  len         (see Note #1).              */
#define  TERMINAL_CFG_MAX_PATH_LEN                      128u   /* Cfg max path len         (see Note #2).              */
